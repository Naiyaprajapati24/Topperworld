...
class OnlineVotingSystem {
    ...
    public static void main(String[] args) {
        ...
        JRadioButton r1 = new JRadioButton("ELVISH");
        JRadioButton r2 = new JRadioButton("ABHISHEK");
        JRadioButton r3 = new JRadioButton("MANISHA");
        ...
        b2.addMouseListener(
                new MouseListener() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        JOptionPane.showMessageDialog(new JFrame(), "ALVISH gets " + A + " votes\n ABHISHEK gets " + B
                                + " votes\n MANISHA gets " + C + "votes\n\n" + out);
                    }
                });
        f.add(p);
        f.setSize(580, 600);
